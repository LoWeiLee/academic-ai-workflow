...
**版本**：v1.1.1｜修正 citation_expand.py 與 keyword_search.py 解析 OpenAlex venue 時 source 為 null 即崩潰的 bug。v1.1.0｜新增無工作區模式（claude.ai 等無持久檔案系統的環境）降級分支；錯誤處理表明載 claude.ai 沙盒網域白名單事實。v1.0.1｜紅隊審查修訂
