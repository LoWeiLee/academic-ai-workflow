...
**版本**：v1.1.2｜coding reliability 骨架版於入口揭露；去識別化閘門補「同意未明文涵蓋 AI」補救路徑；補控制檔模板出處。v1.1.1｜版本對齊重打包（無內容變更）。v1.1.0｜新增無工作區模式（claude.ai 等無持久檔案系統的環境）降級分支。v1.0.1｜紅隊審查修訂
